...
coreshop.provider.gateways.postfinance = Class.create(coreshop.provider.gateways.abstract, {
  ...
  getLayout: function (config) {
    const storeEnvironments = new Ext.data.ArrayStore({
    ...
    Ext.Array.each(this.optionalFields, (field) => {
      const value = config.optionalParameters && config.optionalParameters[field] ? config.optionalParameters[field] : '';
